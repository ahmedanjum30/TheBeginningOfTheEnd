    ...
    <GradientBackground>
      <View className="flex-1 px-4 py-6">
        ...
        <RNTextInput
          ...
          className="mb-4 px-4 py-3 rounded bg-gray-100 border-2 border-blue-200"
          autoCapitalize="none"
          autoCorrect={false}
